...
class CreateAccount extends Component {
  ...
  toggleSwitch1 = value => {
    if (value) {
      SyncStorage.set('backgroundColor', '#ff0000')
          ...
          {nav === 'rate1' ? (
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if(text === this.props.isLoading.Config.languageJson['Official Website']) {
                  Linking.openURL(nav)
                }else if(text === this.props.isLoading.Config.languageJson2[
                  'Dark Mode'
                ]){
