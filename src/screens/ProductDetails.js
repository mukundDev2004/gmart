...
class ProductDetail extends PureComponent {
  ...
  componentDidMount () {
    ...
    if (this.props.navigation.state.params.objectArray.products_type == 1) { this.state.cartButton = 'addToCart' }
    if (this.props.navigation.state.params.objectArray.products_type == 2) { this.state.cartButton = 'external' }
    ...
    <View
      ...
      <HTML
        ...
        baseFontStyle={{
          ...
          color: decoration === 'line-through' ? '#707070' : themeStyle.textColor,
  ...
  calculatingTotalPrice = function () {
    ...
    if (
      this.props.navigation.state.params.objectArray.discount_price != null ||
      this.props.navigation.state.params.objectArray.discount_price != undefined
    ) { this.state.discount_price = totalPrice } else this.state.product_price = totalPrice
  }
                    ...
                    this.props.navigation.state.params.objectArray
                      .discount_price != null ? (
                        <View
                          ...
                          <Text style={{ color: themeStyle.otherBtnsText, padding: 5, zIndex: 2 }}>
                            {this.pDiscount() +
                            ' ' +
                  ...
                  renderItem={item => (
                    <View>
                      <View style={{ padding: 8 }}>
                        <Text>{item.item.option.name}</Text>
                      </View>
                      <FlatList
                        style={{ backgroundColor: themeStyle.backgroundColor }}
