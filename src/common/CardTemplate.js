...
class CardTemplate extends Component {
  ...
  newMethod6 = (props, t) => {
   ...
   qunatityPlus = q => {
    ...
    console.log(this.props.cartProductArrayViewedProducts)
  }
  ...
  newMethod62 = (props, t) => {
    t.setState({ isLoading: true, counter: t.state.counter - 1 })
    console.log(props.cardStyleE, 'wwefnjwnefnkdmfl,s;f.;ggd',props.objectArray.quantity,'aasssdgedtwet',props.objectArray.id);
    if (props.cardStyleE === 23) {
      if (
        props.objectArray.quantity === undefined ||
        props.objectArray.quantity === null
        ...
        props.cartProductArrayViewedProducts.map((val, key) => {
          ...
          console.log( 'sdfghjdhfghddg');
          if (val.products_id === props.objectArray.id) {
            console.log(val.products_id, 'id valure hdfhddg',props.objectArray.id);
            val.quantity = val.quantity - 1
            props.objectArray.quantity = val.quantity
          } else {
            console.log(val.products_id, 'safadgfadhfjyrjyjytjyt',props.objectArray.id);
            props.objectArray.quantity = 1
          }
        })
      } else {
        ...
        props.cartProductArrayViewedProducts.map((val, key) => {
          console.log(val.products_id, 'vvvvvvvvvvvvvvvvvv',props.objectArray.id);
          if (val.products_id === props.objectArray.id) {
            val.quantity = val.quantity - 1
            props.objectArray.quantity = val.quantity
          }
          console.log( props.objectArray.quantity,'ssdhbanmssssssssss');
        })
      }
      setTimeout(() => {
        console.log(props.objectArray.quantity,'aggggggfgfgfgfgfgfgfgfgfgf');
        t.setTimePassed(props, props.objectArray.quantity)
      }, Math.floor(100 / 360000))
    } else {
      console.log( 'asffasfsdgfhdfhdfhsdfghjdhfghddg');
